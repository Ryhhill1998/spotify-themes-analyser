...
async def main():
    ...
    with get_db_session() as db_session:
        ...
        profile = await profile_pipeline.run(access_token="BQCESkxFg8qnBMouoWj4mvPllMAN2535x1Y3UArk2JTgQABwfJ3gUN8C5pUxZus23VWtYQdmGGOC3zyRBpeyu3aKhKJZby-_0WiA23QZe-deWhn86YdvHXjvEgyBAfuvtWyJJe4fvfSm82iTOEqYq7dE-9PtHa1MIsV97Y7_LQN2wtijHg6R-8hfP504qntbefaxQkntb-OXD7KnYeDPEVoPK9cCaKalITvBfjqT_gibxaiKDbuWJOkd")
        print(profile)
